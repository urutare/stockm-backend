...
set repositories=("stockm-category-service", "stockm-sync-service", "stockm-stock-service", "stockm-discovery-service", "stockm-auth-service", "stockm-api-gateway", "stockm-payment-service", "stockm-common-core", "sms-gateway")
